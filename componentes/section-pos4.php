        ...
        <div class="d-flex align-items-center justify-content-center">
            <div class="p-5 mb-4 bg-dark rounded-3">
                <div class="container-fluid py-5 text-center">
                    ...
                    <p class="text-white">Prueba todas nuestras funcionalidades de a grapa. Más de 500 negocios nos eligen..</p>
                    <a class="btn btn-lg btn-outline-light mt-5 btnEmpezarGratis" type="button" href="javascript:void(0)">Prueba gratis</a>
