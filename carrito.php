...
<body style="background-color:#F1F5F9; position: relative;">
    ...
    <div class="container mb-5">
                    ...
                    <div class="card-body d-flex flex-column align-items-center">
                        ...
                        <div>
                            ...
                            <?php else : ?>
                                <span> Desde </span>
                                <h2 class="text-pos-1">$ <?= $_basic_a['precio_descuento'] ?> <sup class="text-pos-3"> <strong> MXN/MES </strong></sup> </h2>
                                renovación $ <?= $_basic_a['precio_descuento_r'] ?> MXN
                                <p class="text-pos-3 "> <strong> <s>ANTES</s> <s>$ <?= $_basic_a['precio_real'] ?> </s> <s>MXN</s> <s>/MES</s> <i>Ahorra $ <?= $_basic_a['ahorro'] * 12 ?> MXN</i>  </p></strong>
                            <?php endif; ?>
                        </div>
                        <!-- <ul>
                            <li><i class="fas fa-check text-success"></i> Licencia para <strong>1</strong> sucursal</li>
                    ...
                    <div class="card-body d-flex flex-column align-items-center">
                        ...
                        <div>
                            ...
                            <?php else : ?>
                                <span> Desde </span>
                                <h2 class="text-pos-1">$ <?= $_plus_a['precio_descuento'] ?> <sup class="text-pos-3"> <strong> MXN/MES </strong></sup> </h2>
                                renovación $ <?= $_plus_a['precio_descuento_r'] ?> MXN
                                <p class="text-pos-3 "> <strong> <s>ANTES</s> <s>$ <?= $_plus_a['precio_real'] ?> </s> <s>MXN</s> <s>/MES</s> <i>Ahorra $ <?= $_plus_a['ahorro'] * 12 ?> MXN</i> <br>  </p></strong>
                            <?php endif; ?>
                        </div>
                        <!-- <ul>
                            <li><i class="fas fa-check text-success"></i> Licencia para <strong>1</strong> sucursal</li>
        ...
        <?php require_once 'componentes/section-pos1.php' ?>
        <?php require_once 'componentes/section-pos4.php' ?>
        <?php require_once 'componentes/section-pos5.php' ?>
